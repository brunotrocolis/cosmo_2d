...
const A = [160, 120], E = [240, 160], G = [320, 240], I = [400, 240], V = [480, 320], X = [640, 360], H = [640, 480], F = [800, 480], T = [854, 480], W = [960, 540], Y = [960, 640], C = [800, 600], S = [1024, 600], B = [1024, 768], D = [1280, 720], L = [1280, 720], Q = [1280, 1024], R = [1920, 1080], q = [1920, 1080], O = [2560, 1440], P = !1, j = !0, N = "0.2.0", U = n.time, J = n.key, K = n.touch;
